...
BuildRequires:  python3-pyroute2 >= 0.5.6
...
%changelog
* Fri Nov 12 2021 RDO <dev@lists.rdoproject.org> 1:16.4.2-1
- Update to 16.4.2

* Fri Sep 10 2021 RDO <dev@lists.rdoproject.org> 1:16.4.1-1
- Update to 16.4.1
...
* Thu Mar 18 2021 RDO <dev@lists.rdoproject.org> 1:16.3.1-1
- Update to 16.3.1

* Thu Jan 28 2021 RDO <dev@lists.rdoproject.org> 1:16.3.0-1
- Update to 16.3.0

* Wed Oct 07 2020 RDO <dev@lists.rdoproject.org> 1:16.2.0-1
- Update to 16.2.0
...
# REMOVEME: error caused by commit https://opendev.org/openstack/neutron/commit/4f03e76aaafbbc871a6f5c3fc4ecca4298635d6f
