...
%changelog
* Tue Oct 22 2019 RDO <dev@lists.rdoproject.org> 1:12.1.1-1
- Update to 12.1.1

* Thu Jul 04 2019 RDO <dev@lists.rdoproject.org> 1:12.1.0-1
- Update to 12.1.0

* Fri Apr 12 2019 RDO <dev@lists.rdoproject.org> 1:12.0.6-1
- Update to 12.0.6

* Tue Nov 06 2018 RDO <dev@lists.rdoproject.org> 1:12.0.5-1
- Update to 12.0.5

* Tue Sep 18 2018 RDO <dev@lists.rdoproject.org> 1:12.0.4-1
- Update to 12.0.4

* Mon Jun 18 2018 RDO <dev@lists.rdoproject.org> 1:12.0.3-1
- Update to 12.0.3

* Tue May 08 2018 RDO <dev@lists.rdoproject.org> 1:12.0.2-1
- Update to 12.0.2

* Thu Mar 29 2018 RDO <dev@lists.rdoproject.org> 1:12.0.1-1
- Update to 12.0.1
