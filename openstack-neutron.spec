...
Requires:       python3-ovsdbapp >= 1.9.2
...
%changelog
* Thu Jul 21 2022 RDO <dev@lists.rdoproject.org> 1:18.5.0-1
- Update to 18.5.0

* Wed May 25 2022 RDO <dev@lists.rdoproject.org> 1:18.4.0-1
- Update to 18.4.0

* Thu Apr 21 2022 RDO <dev@lists.rdoproject.org> 1:18.3.0-1
- Update to 18.3.0

* Thu Jan 13 2022 RDO <dev@lists.rdoproject.org> 1:18.2.0-1
- Update to 18.2.0

* Fri Sep 10 2021 RDO <dev@lists.rdoproject.org> 1:18.1.1-1
- Update to 18.1.1

* Mon Jul 12 2021 RDO <dev@lists.rdoproject.org> 1:18.1.0-1
- Update to 18.1.0

* Wed Apr 14 2021 RDO <dev@lists.rdoproject.org> 1:18.0.0-1
- Update to 18.0.0

* Tue Apr 06 2021 RDO <dev@lists.rdoproject.org> 1:18.0.0-0.2.0rc1
...
# REMOVEME: error caused by commit https://opendev.org/openstack/neutron/commit/8b1ec76321e33406c06f8cc49489dbdceeb0ee91
