...
%changelog
* Thu Jan 13 2022 RDO <dev@lists.rdoproject.org> 1:17.3.0-1
- Update to 17.3.0

* Fri Sep 10 2021 RDO <dev@lists.rdoproject.org> 1:17.2.1-1
- Update to 17.2.1

* Mon Jul 12 2021 RDO <dev@lists.rdoproject.org> 1:17.2.0-1
- Update to 17.2.0

* Mon May 10 2021 RDO <dev@lists.rdoproject.org> 1:17.1.2-1
- Update to 17.1.2

* Thu Jan 28 2021 RDO <dev@lists.rdoproject.org> 1:17.1.0-1
- Update to 17.1.0
...
# REMOVEME: error caused by commit https://opendev.org/openstack/neutron/commit/0396331f57e83f63807daddf122dc58bcb63f0ef
