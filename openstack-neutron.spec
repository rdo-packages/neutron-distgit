...
%changelog
* Mon Jun 18 2018 RDO <dev@lists.rdoproject.org> 1:10.0.7-1
- Update to 10.0.7

* Tue May 08 2018 RDO <dev@lists.rdoproject.org> 1:10.0.6-1
- Update to 10.0.6
...
* Mon Sep 25 2017 rdo-trunk <javier.pena@redhat.com> 1:10.0.4-1
- Update to 10.0.4

* Mon Aug 28 2017 rdo-trunk <javier.pena@redhat.com> 1:10.0.3-1
- Update to 10.0.3
...
# REMOVEME: error caused by commit http://git.openstack.org/cgit/openstack/neutron/commit/?id=c717a904dabcb2ec56333288533bdeeec27bd86e
