...
BuildRequires:  python3-pyroute2 >= 0.5.14
...
%changelog
* Thu Apr 13 2023 RDO <dev@lists.rdoproject.org> 1:19.7.0-1
- Update to 19.7.0

* Tue Mar 14 2023 RDO <dev@lists.rdoproject.org> 1:19.6.0-1
- Update to 19.6.0

* Fri Feb 03 2023 RDO <dev@lists.rdoproject.org> 1:19.5.0-1
- Update to 19.5.0
...
* Wed May 25 2022 RDO <dev@lists.rdoproject.org> 1:19.3.0-1
- Update to 19.3.0

* Thu Apr 21 2022 RDO <dev@lists.rdoproject.org> 1:19.2.0-1
- Update to 19.2.0

* Mon Jan 10 2022 RDO <dev@lists.rdoproject.org> 1:19.1.0-1
- Update to 19.1.0

* Wed Oct 06 2021 RDO <dev@lists.rdoproject.org> 1:19.0.0-1
- Update to 19.0.0

* Sat Oct 02 2021 RDO <dev@lists.rdoproject.org> 1:19.0.0-0.2.0rc1
...
# REMOVEME: error caused by commit https://opendev.org/openstack/neutron/commit/6172f4233ef0bd1199deacefbf81f3104b5ccc7a
